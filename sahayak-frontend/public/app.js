// app.js (Version before language selection feature)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Helper Functions and Display Logic ---
    ...
    function displayLessonPlan(data, el) {
        ...
        confirmation.innerHTML = `<strong>Success!</strong> Your lesson plan has been generated. An email simulation was run and an invite has been created for your Google Calendar.`;
        el.appendChild(confirmation);

        const actions = document.createElement('div');
        actions.className = 'actions-container';
        actions.innerHTML = `<a href="${data.calendar_link}" target="_blank" class="action-btn">Open Google Calendar Invite</a>`;
        el.appendChild(actions);

        const lessonPlanData = { ...data };
        delete lessonPlanData.calendar_link;

        const content = document.createElement('div');
        for (const [key, value] of Object.entries(lessonPlanData)) {
